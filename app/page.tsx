...
export default function ComingSoonPage() {
  return (
    <div className="relative h-screen w-full flex flex-col items-center justify-center bg-void overflow-hidden px-6">
      
      {/* Background Industrial Accents */}
      <div className="absolute inset-0 opacity-[0.03] pointer-events-none" 
        style={{ backgroundImage: `radial-gradient(circle at 2px 2px, #c6ff00 1px, transparent 0)`, backgroundSize: '40px 40px' }} 
      />
      
      <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-acid to-transparent opacity-50" />
      ...
      <div className="relative z-10 text-center flex flex-col items-center">
        ...
        >
          ...
          <span className="font-mono text-[10px] tracking-[4px] uppercase text-acid font-bold">
            System Deployment
          </span>
          <span className="w-8 h-px bg-acid" />
        </motion.div>
        ...
        <motion.h1 
          ...
          className="font-display leading-[0.85] tracking-tighter text-chrome mb-6"
          style={{ fontSize: 'clamp(80px, 15vw, 180px)' }}
        >
          TESSCH<span className="text-acid">.</span>
        </motion.h1>
        ...
        <motion.div 
          ...
          className="bg-acid text-void px-8 py-4 mb-10 skew-x-[-12deg]"
        >
          <p className="font-mono text-xl md:text-2xl font-black uppercase tracking-[2px] skew-x-[12deg]">
            LIVE ON 17.04.2026
          </p>
        </motion.div>
        ...
        <motion.p 
          ...
          className="font-mono text-[11px] md:text-[13px] text-muted tracking-[3px] uppercase max-w-[300px] leading-relaxed"
        >
          The modular sneaker archive is currently being assembled. 
          <br/>
          <span className="text-fire mt-4 block">Access Restricted.</span>
        </motion.p>
      </div>
      ...
      <div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-4 opacity-40">
        ...
        <span className="font-mono text-[9px] tracking-[5px] uppercase text-chrome">STAY TUNED</span>
      </div>

      {/* Side Metadata */}
      <div className="absolute left-6 bottom-10 hidden md:block">
        <p className="font-mono text-[8px] text-muted uppercase rotate-[-90deg] origin-left tracking-[4px]">
          ARC_v.1.0 // 2026
        </p>
      </div>
    </div>
