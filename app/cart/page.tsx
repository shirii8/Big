    ...
    <div className="min-h-screen bg-[#e5f1ee] text-[#17191d] pt-28 pb-20 px-6 md:px-12">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-12 border-b-2 border-[#17191d] pb-6 flex items-end justify-between">
          ...
          <p className="font-mono text-[11px] uppercase tracking-[2px] opacity-40">{totalItems} UNIT{totalItems !== 1 ? 'S' : ''} STAGED</p>
        </div>
                    ...
                    <div className="flex flex-col md:flex-row">
                      ...
                      <div className="flex-1 p-6 flex flex-col gap-4">
                        <div className="flex justify-between items-start">
                          <div>
                            <p className="font-mono text-[9px] text-[#d4604d] font-bold uppercase tracking-[2px]">{item.upper.category} UPPER</p>
                        ...
                        <div className="flex flex-col gap-2">
                          <p className="font-mono text-[9px] uppercase tracking-[3px] opacity-40">Build Configuration</p>
                          ...
                          {!isBuild && (
                            <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }} className="bg-[#d4604d]/10 border border-[#d4604d] px-4 py-3 mt-1">
                              <p className="font-mono text-[9px] text-[#d4604d] font-bold uppercase tracking-[2px]">
                                ⚠ You&apos;re missing out on the SOLE — Full Build unlocks 15 base units + saves ₹{item.sole ? item.sole.price - 500 : 500} on bundle pricing.
                              </p>
                            </motion.div>
                          )}
                          ...
                          {isBuild && item.sole && (
                            <div className="flex items-center gap-3 bg-[#17191d]/5 px-4 py-3 mt-1 border border-[#17191d]/10">
                              ...
                              <div>
                                <p className="font-mono text-[8px] uppercase tracking-[2px] opacity-40">Base Unit</p>
                                <p className="font-mono text-[10px] font-bold uppercase">{item.sole.name}</p>
                              </div>
                              <Link href="/products/soles" className="ml-auto font-mono text-[9px] text-[#d4604d] border-b border-[#d4604d] hover:opacity-70 transition-opacity uppercase">
                                Change →
                              </Link>
                            </div>
                          )}
                        ...
                        <div className="flex items-center justify-between pt-3 border-t border-[#17191d]/10">
                          ...
                          <div className="text-right">
                            <p className="font-mono text-[9px] opacity-40 uppercase">Unit Price</p>
            ...
            <div className="bg-[#17191d] text-[#e5f1ee] p-8 flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-3 border-t border-[#e5f1ee]/10 pt-6">
                <div className="flex justify-between font-mono text-[10px] uppercase">
                  <span className="opacity-60">Subtotal ({totalItems} units)</span>
